...
export default function DataTable<TData, TValue>({ columns, data, onSelectionChange }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="relative grid h-full max-h-[calc(100vh-var(--contiss-header-height)-var(--contiss-footer-height)-20rem)] w-full flex-1 overflow-hidden overflow-x-auto overflow-y-auto rounded-md border border-black/10 dark:border-white/10">
